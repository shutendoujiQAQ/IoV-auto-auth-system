...
- Visual scene classification via Vision-Language Model (Gemma3:27B).
- Environmental sound classification with CAMPPlus-Fbank.
...
- Real-time testing in CARLA simulation environment.
